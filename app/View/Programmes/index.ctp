<div class="programmes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('programme'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($programme['Programme']['programme']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $programme['Programme']['id']), array(), __('Are you sure you want to delete # %s?', $programme['Programme']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
